...
if (cmd === `${prefix}about` | cmd === `${prefix}ab`) bot.chat(`Made by Someone8448#6969, Songs: ${midis.length}, OS: ${process.platform}`)
...
maxnq = 12000
nqallow = 4000
nqint = setInterval(() => {nq += nqallow; if (nq > maxnq) nq=maxnq;},2000)
bot.client.on('nq', msg => {nqallow = msg.allowance;maxnq = msg.max; nq = msg.max})
